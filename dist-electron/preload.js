...
electron_1.contextBridge.exposeInMainWorld('electronAPI', {
    ...
    database: {
        ...
        // Expenses
        getExpenses: () => electron_1.ipcRenderer.invoke('db:get-expenses'),
        createExpense: (expense) => electron_1.ipcRenderer.invoke('db:create-expense', expense),
        updateExpense: (id, expense) => electron_1.ipcRenderer.invoke('db:update-expense', id, expense),
