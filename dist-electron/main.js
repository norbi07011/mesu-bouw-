...
electron_1.ipcMain.handle('db:create-expense', async (event, expense) => {
    return dbService.createExpense(expense);
});
electron_1.ipcMain.handle('db:update-expense', async (event, id, expense) => {
    return dbService.updateExpense(id, expense);
});
electron_1.ipcMain.handle('db:delete-expense', async (event, id) => {
